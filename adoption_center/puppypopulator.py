...
from puppy_shelter import Base, Shelter, Puppy, PuppyProfile, Person
...
persons = ["James", "Sue", "Meryl", "Bob", "Dona"]
...
#This method will create a random weight between 100-4000 pounds/100 (or whatever unit of measure you prefer)
def CreateRandomWeight():
	return (random.uniform(1.0, 40.0) * 100)
...
for puppy in session.query(Puppy).all():
	puppy_profile = PuppyProfile(puppy_id = puppy.id, picture = puppy.picture)
	session.add(puppy_profile)
	session.commit()
